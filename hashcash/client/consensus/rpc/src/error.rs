...
mod codes {
	...
	pub const EMPTY_SHARES: i32 = BASE + 4;
	pub const INHERENTS: i32 = BASE + 5;
	pub const RUNTIME_API: i32 = BASE + 6;
	pub const STORAGE_CHANGES: i32 = BASE + 7;
	pub const PROPOSER: i32 = BASE + 8;
	pub const OTHER: i32 = BASE + 9;
}
...
impl From<Error> for ErrorObjectOwned {
	fn from(e: Error) -> Self {
		match e {
			...
			Error::EmptyShares(e) => ErrorObject::owned(codes::EMPTY_SHARES, e, None::<()>),
